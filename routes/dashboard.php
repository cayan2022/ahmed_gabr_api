    ...
    ->group(function () {
        ...
        Route:: as('pages.')
            ...
            ->group(function () {
                ...
                /*gallery*/
                Route::group([], function () {
                    Route::put('galleries/{gallery}/block', [GalleryController::class, 'block'])->name('galleries.block')->middleware('can:block galleries');
                    Route::put('galleries/{gallery}/active', [GalleryController::class, 'active'])->name('galleries.active')->middleware('can:active galleries');
                    Route::post('galleries/{gallery}', [GalleryController::class, 'update'])->name('galleries.update')->middleware('can:update galleries');
                    Route::apiResource('galleries', GalleryController::class)->except('update')->middleware('check_permissions');
                    Route::get('delete_media/{id}', [GalleryController::class, 'deleteMedia']);
                });
